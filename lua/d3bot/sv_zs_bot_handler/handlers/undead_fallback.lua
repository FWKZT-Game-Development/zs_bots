...
function HANDLER.CanBeTgt(bot, target)
	...
	if target:IsPlayer() and ( target:GetStatus("hidden") and target:Crouching() ) and not (target:IsPlayer() and target == GAMEMODE.TheLastHuman) then return end -- Ignore player who is hidden.
